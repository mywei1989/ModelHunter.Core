...
exports.getCollectionObjList = function(trgFile){
  ...
  return this.readFileInfo2(collectionObjList);
}

exports.readFileInfo2 = function(collectionObjList){
  for(let index = 0;index<collectionObjList.length;index++){
    //console.log('3.读取csv文件:'+collectionObjList[index].csvPath);
    collectionObjList[index].fileInfo = csv.readSync2(collectionObjList[index].csvPath);
  }
