...
exports.init = function(){
  ...
  createPromise.then(function(trgFiles){
    ...
    //fs.writeFileSync('i:/test.json',JSON.stringify(collectionObjList[0]));
    /*redisClient.set(collectionObjList[0].sectionName,JSON.stringify(collectionObjList[0]),function(err,res){
      console.log(err);
      console.log(res);
      process.exit();
    });*/
